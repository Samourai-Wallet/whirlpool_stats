...
setup(
  ...
  url='https://code.samourai.io/whirlpool/whirlpool_stats',
  download_url='https://code.samourai.io/whirlpool/whirlpool_stats/-/archive/v0.4.1/whirlpool_stats-v0.4.1.tar.gz',
